...
const Contact = () => {
  const { SVGRef } = useInView({ triggerOnce: true });
  const ref = useInView({
    triggerOnce: false, // Allows animation to run every time it comes into view
    ...
    <motion.div  className='contact' ref={ref.ref} variants={SocialMediaVariant} initial='initial' animate='animate'>
      ...
      <motion.div className='wrapper' variants={SocialMediaVariant}>
        <motion.div className='textContainer' variants={SocialMediaVariant}>
          <motion.h1 variants={SocialMediaVariant}>
            Let&apos;s Work <span>Together</span>
          </motion.h1>
          <motion.div className='socialMedia' variants={SocialMediaVariant}>
            <a
            ...
            <motion.a href='#' className='icon email' variants={SocialMediaVariant}>
              <MdEmail />
            </motion.a>
          </motion.div>
        </motion.div>
        <div className='svgContainer'>
          <motion.div ref={SVGRef} className='phoneSVG'>
